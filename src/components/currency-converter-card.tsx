...
export function CurrencyConverterCard() {
  ...
  const validationSchema = useMemo(() => createConversionFormSchema(t), [t]);
          ...
          <div className="flex gap-3 items-end">
            ...
            <div className="flex-1">
              ...
              <CurrencySelector
                ...
                disabled={
                  convertMutation.isPending || currenciesQuery.isLoading
                }
              />
            </div>
            ...
            <>
              <div className="border-t border-slate-200 pt-3 sm:pt-4">
                <p className="text-xs sm:text-sm text-slate-600">
                  {t('converter.statistics.totalConversions')}
                </p>
              ...
              {stats.mostConvertedCurrency && (
                <>
                  <div>
                    <p className="text-xs sm:text-sm text-slate-600">
                      {t('converter.statistics.mostConverted')}
                    </p>
                    <p className="text-lg sm:text-xl font-semibold text-slate-900">
                      {stats.mostConvertedCurrency}
                    </p>
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-slate-600">
                      {t('converter.statistics.totalAmount', {
